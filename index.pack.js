...
var _openai = __webpack_require__(14);

function _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step("next", value); }, function (err) { step("throw", err); }); } } return step("next"); }); }; } // import { process } from './env.js';


var mascotText = document.getElementById('mascot-text');
// const configuration = new Configuration({ apiKey });
var apikeyBtn = document.getElementById('apikey-btn');
...
apikeyBtn.addEventListener('click', function () {
    ...
    if (apiKey.length > 0) {
        var fetchBotReply = function () {
            var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(idea) {
                var response;
            ...
            return function fetchBotReply(_x) {
                return _ref.apply(this, arguments);
            };
        }();

        var fetchIdea = function () {
            var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(idea) {
                var response, outline;
                    ...
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            ...
                            case 2:
                                ...
                                outline = response.data.choices[0].text.trim();
            ...
            return function fetchIdea(_x2) {
                return _ref2.apply(this, arguments);
            };
        }();

        var configuration = new _openai.Configuration({ apiKey: apiKey });
        var openai = new _openai.OpenAIApi(configuration);
        apiKeyInput.value = '';
        document.getElementById('api-key-error').innerHTML = 'API key saved!';

        document.getElementById("send-btn").addEventListener("click", function () {
            var setupTextArea = document.getElementById('setup-textarea');
            if (setupTextArea.value) {
                var userInput = setupTextArea.value;
                var setupInputContainer = document.getElementById('setup-input-container');
                var mascotImage = document.getElementById('mascot');
                mascotImage.style.display = 'none';
                var mascotThinking = document.getElementById('mascot-thinking');
                ...
                var _mascotText = document.getElementById('mascot-text');
                _mascotText.innerHTML = 'Ok let me think...';
...
const packageJson = __webpack_require__(37);
class Configuration {
    constructor(param = {}) {
        ...
        if (!this.formDataCtor) {
            this.formDataCtor = __webpack_require__(33);
        }
    }
    /**
